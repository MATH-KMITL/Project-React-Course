...
console.log(`ข้อ 16 : arr1 = [ ${arr1} ] และ arr2 = [ ${arr2} ] ` )
console.log(`จะได้ [ ${mergeArr(arr1,arr2)} ]`)
console.log('////////////////////////////////////////////////////')
...
dogsTest = (dogs) => {
    ...
    for(let i = 0 ; i<dogs.length ; i++) 
        Mydogs = Mydogs + ` { title: ${dogs[i].title}, age: ${dogs[i].age} }  `
    return Mydogs
}
console.log(`ข้อ 17 : ทดสอบ dogs = ${dogsTest(dogs)} ` )
console.log(`เรียงสุนัขตามอายุจะได้ dogs = ${dogsTest(sortDogByAge(dogs))}` )
console.log('/////////////////////////////////////////////////////////////////')
